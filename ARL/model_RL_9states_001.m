function [action,state_of_three_model, q_of_model,p_of_model,which_model_was_choosen] = model_RL_9states_001(options,last_action,state_of_three_model,p_of_model,q_of_model,lamda_of_3model,alpha_of_3model, last_score)
