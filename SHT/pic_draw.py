...
def choice_reward_pic(save_path,nD,agent_dict):
    ...
    pic_path = r'E:'+'/'+save_path
    if not os.path.exists(pic_path):
        os.makedirs(pic_path)
    choice_reward_pair=pd.read_csv(r'E:\humans-combine-value-learning-and-hypothesis-testing-main\choice_reward_pair.csv')
    ...
    for subject in df_data['agent_id'].unique():
        ...
        # for i,dim in enumerate(['pos_1','pos_2','pos_3','pos_4']):
