...
all_unique_values_df.to_csv(r"results/fRL/4D_results/all_unique_values_fRL.csv", index=False)
...
for agent_id in range(100):
    ...
    if phase == 'P1':
        agent_dict = {'agent_id':[],'round':[],'score':[],
                ...
                'pos_1':[],'pos_2':[],'pos_3':[],'W_val':[], 'action':[], 'Q_values':[]}
    else:
        agent_dict = {'agent_id':[],'round':[],'score':[],
                'choice_1':[],'choice_2':[],'choice_3':[],'choice_4':[],
                'pattern_1':[],'pattern_2':[],'pattern_3':[],'pattern_4':[],
                'pos_1':[],'pos_2':[],'pos_3':[],'pos_4':[],'W_val':[], 'action':[], 'Q_values':[]}
...
# while(True):
        for i in range(steps):
            ...
            # indices = [all_unique_values[all_unique_values['combine'] == str(val)].index[0] for val in input_data]
            ...
            # #         #print(act_data)
            # else:
            action, Q_values = policy.policy(converted)
            ...
            act_data = input_data[action].tolist()
            act_data = [ast.literal_eval(item) for item in act_data]
            # print(act_data)
            ...
            agent_dict['Q_values'].append(Q_values)
            ...
            if reward == 100 or total_step==50:
                ...
                # exit()
                pic_draw.choice_reward_pic('4D_results',nD,agent_dict)
