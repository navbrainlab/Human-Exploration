...
def score(group):
    ...
    return score_of_food['dim1'][int(group[1]) - 1] +  score_of_food['dim2'][int(group[2]) - 1]
...
all_unique_values_df.to_csv(r"results/naive_RL/4D_results/all_unique_values_naiveRL.csv", index=False)
