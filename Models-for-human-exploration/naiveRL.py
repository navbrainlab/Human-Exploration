...
all_unique_values_df.to_csv(r"C:\Users\Windows11\Desktop\all_unique_values_naiveRL.csv", index=False)
...
for agent_id in range(100):
    ...
    # print(steps)
        for i in range(steps):
            ...
            action = policy.policy(Q_table_small) #该动作的索引
            ...
            if reward == 100 or total_step >=30 :
                pic_draw.choice_reward_pic('naive_RL_0624',nD,agent_dict)
                not_fullscore = False
