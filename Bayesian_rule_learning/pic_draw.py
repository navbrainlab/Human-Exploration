...
def choice_reward_pic(save_path,nD,agent_dict):
    ...
    pic_path = r'C:\Users\Windows11\Desktop'+'/'+save_path
    if not os.path.exists(pic_path):
        os.makedirs(pic_path)
    choice_reward_pair=pd.read_csv(r'C:\Users\Windows11\Desktop\humans-combine-value-learning-and-hypothesis-testing-main\humans-combine-value-learning-and-hypothesis-testing-main\choice_reward_pair.csv')
